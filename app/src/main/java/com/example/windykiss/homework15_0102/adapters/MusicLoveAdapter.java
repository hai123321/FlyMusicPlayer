...
public class MusicLoveAdapter extends RecyclerView.Adapter<MusicViewHolder> {
    ...
    public void onBindViewHolder(MusicViewHolder holder, int position) {
        holder.bind(DBContext.getInstance().findAllMusicLove().get(position));
    }

    @Override
    public int getItemCount() {
        return DBContext.getInstance().findAllMusicLove().size();
    }
}